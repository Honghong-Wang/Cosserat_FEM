...
print(u[-12:, 0])
print(L - u[-12:, 0])
print(-L * fapp__[-1] / ElasticityExtension[2, 2] + L)
print(max_load / ElasticityExtension[2, 2] * (node_data + l0 * np.sinh((1 - 2 * node_data) / 2 / l0) / (np.cosh(1 / 2 / l0)) - l0 * np.tanh(1 / 2 / l0)))